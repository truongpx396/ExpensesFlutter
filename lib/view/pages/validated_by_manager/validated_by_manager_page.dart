...
import 'package:expenses_mobile/view_model/pending_on_manager/pending_on_manager_vm.dart';
import 'package:expenses_mobile/view_model/validated_by_manager/validated_by_manager_vm.dart';
import 'package:flutter/material.dart';

class ValidatedByManagerPage extends StatefulWidget {
  @override
  _ValidatedByManagerPageState createState() => _ValidatedByManagerPageState();
}

class _ValidatedByManagerPageState extends State<ValidatedByManagerPage> {
  ValidatedByManagerViewModel _vm;
  ...
  Widget build(BuildContext context) {
    return BaseWidget<ValidatedByManagerViewModel>(
      model: ValidatedByManagerViewModel(),
      onModelReady: (model) {
        _vm = model;
        _vm.loadList();
      },
