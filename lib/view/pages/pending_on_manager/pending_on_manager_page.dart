...
class PendingOnManagerPage extends StatefulWidget {
  @override
  _PendingOnManagerPageState createState() => _PendingOnManagerPageState();
}

class _PendingOnManagerPageState extends State<PendingOnManagerPage> {
  PendingOnManagerViewModel _vm;
  ...
  Widget build(BuildContext context) {
    return BaseWidget<PendingOnManagerViewModel>(
      model: PendingOnManagerViewModel(),
      onModelReady: (model) {
        _vm = model;
        _vm.loadList();
      },
